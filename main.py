...
def create_html_report(output_dir="reports", markdown_content=""):
    ...
    report_path = output_path / "internet_report.html"
...
def main():
    ...
    report_path = create_html_report(markdown_content=report)
    print(report_path)
